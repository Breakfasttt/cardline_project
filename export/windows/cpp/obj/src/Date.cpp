...
HX_DEFINE_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_27_new,"Date","new",0x9aa26240,"Date.new","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",27,0x54f30f43)
HX_LOCAL_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_31_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",31,0x54f30f43)
HX_LOCAL_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_51_now,"Date","now",0x9aa26af6,"Date.now","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",51,0x54f30f43)
HX_LOCAL_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_54_new1,"Date","new1",0xb37395f1,"Date.new1","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",54,0x54f30f43)
HX_LOCAL_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_57_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",57,0x54f30f43)
HX_LOCAL_STACK_FRAME(_hx_pos_697c8e89a8edcdd9_64_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",64,0x54f30f43)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_27_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_31_getTime)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,getTime,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_51_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::new1( ::Dynamic t){
            	HX_GC_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_54_new1)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,new1,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_57_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_697c8e89a8edcdd9_64_fromString)
