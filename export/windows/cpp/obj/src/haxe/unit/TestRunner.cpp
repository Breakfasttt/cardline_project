...
HX_LOCAL_STACK_FRAME(_hx_pos_d128b1684a30028f_75___default_print,"haxe.unit.TestRunner","__default_print",0xde5b3cc5,"haxe.unit.TestRunner.__default_print","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/unit/TestRunner.hx",75,0x0319b8a8)
namespace haxe{
namespace unit{
...
bool TestRunner_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x496c1fac;
}

HX_BEGIN_DEFAULT_FUNC(__default_print,TestRunner_obj)
void _hx_run( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_d128b1684a30028f_75___default_print)
HXLINE(  75)		::cpp::Lib_obj::print(v);
            	}
