...
void *TestStatus_obj::_hx_vtable = 0;
...
bool TestStatus_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x13cdbcee;
}
...
{
	hx::Object *dummy = new TestStatus_obj;
	TestStatus_obj::_hx_vtable = *(void **)dummy;
