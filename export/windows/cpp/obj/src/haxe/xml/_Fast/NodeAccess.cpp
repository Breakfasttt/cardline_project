...
HX_DEFINE_STACK_FRAME(_hx_pos_23500283a286f02e_29_new,"haxe.xml._Fast.NodeAccess","new",0xde09fb0a,"haxe.xml._Fast.NodeAccess.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",29,0x99ceac73)
namespace haxe{
namespace xml{
namespace _Fast{

void NodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_23500283a286f02e_29_new)
