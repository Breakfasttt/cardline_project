...
HX_DEFINE_STACK_FRAME(_hx_pos_1d73ddc3eaf831df_83_new,"haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",83,0x99ceac73)
namespace haxe{
namespace xml{
namespace _Fast{

void HasNodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_1d73ddc3eaf831df_83_new)
