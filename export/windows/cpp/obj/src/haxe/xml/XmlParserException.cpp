...
HX_DEFINE_STACK_FRAME(_hx_pos_d26689231e5eabf9_77_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",77,0x0b147450)
HX_LOCAL_STACK_FRAME(_hx_pos_d26689231e5eabf9_98_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",98,0x0b147450)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_d26689231e5eabf9_77_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_d26689231e5eabf9_98_toString)
HXLINE(  98)		::String _hx_tmp = (::Type_obj::getClassName(::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this))) + HX_(": ",a6,32,00,00));
