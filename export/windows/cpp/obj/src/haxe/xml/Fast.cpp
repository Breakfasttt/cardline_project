...
HX_DEFINE_STACK_FRAME(_hx_pos_5ce9fc1705431a9a_211_new,"haxe.xml.Fast","new",0xda21546d,"haxe.xml.Fast.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",211,0x99ceac73)
namespace haxe{
namespace xml{

void Fast_obj::__construct( ::Xml x){
            	HX_GC_STACKFRAME(&_hx_pos_5ce9fc1705431a9a_211_new)
