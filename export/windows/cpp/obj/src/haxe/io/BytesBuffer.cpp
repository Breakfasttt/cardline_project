...
HX_DEFINE_STACK_FRAME(_hx_pos_218d5f34ff18ce89_54_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",54,0x829b9665)
HX_LOCAL_STACK_FRAME(_hx_pos_218d5f34ff18ce89_191_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",191,0x829b9665)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_218d5f34ff18ce89_54_new)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_218d5f34ff18ce89_191_getBytes)
