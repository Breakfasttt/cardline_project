...
HX_DEFINE_STACK_FRAME(_hx_pos_e33676f84905ab04_76_new,"haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x24e29567)
HX_LOCAL_STACK_FRAME(_hx_pos_e33676f84905ab04_147_directory,"haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",147,0x24e29567)
HX_LOCAL_STACK_FRAME(_hx_pos_e33676f84905ab04_262_addTrailingSlash,"haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",262,0x24e29567)
HX_LOCAL_STACK_FRAME(_hx_pos_e33676f84905ab04_287_removeTrailingSlashes,"haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",287,0x24e29567)
namespace haxe{
namespace io{

void Path_obj::__construct(::String path){
            	HX_STACKFRAME(&_hx_pos_e33676f84905ab04_76_new)
...
::String Path_obj::directory(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_e33676f84905ab04_147_directory)
...
::String Path_obj::addTrailingSlash(::String path){
            	HX_STACKFRAME(&_hx_pos_e33676f84905ab04_262_addTrailingSlash)
...
::String Path_obj::removeTrailingSlashes(::String path){
            	HX_STACKFRAME(&_hx_pos_e33676f84905ab04_287_removeTrailingSlashes)
