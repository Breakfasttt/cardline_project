...
HX_DEFINE_STACK_FRAME(_hx_pos_df96f08def93db16_102_new,"haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",102,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_128_setResolver,"haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",128,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_147_readDigits,"haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",147,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_172_readFloat,"haxe.Unserializer","readFloat",0x5bd86dcb,"haxe.Unserializer.readFloat","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",172,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_186_unserializeObject,"haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",186,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_201_unserializeEnum,"haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",201,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_233_unserialize,"haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",233,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_70_initCodes,"haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",70,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_466_run,"haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",466,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_63_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",63,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_65_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",65,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_df96f08def93db16_68_boot,"haxe.Unserializer","boot",0x2648e2ed,"haxe.Unserializer.boot","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",68,0x9355143c)
namespace haxe{

void Unserializer_obj::__construct(::String buf){
            	HX_GC_STACKFRAME(&_hx_pos_df96f08def93db16_102_new)
...
void Unserializer_obj::setResolver( ::Dynamic r){
            	HX_GC_STACKFRAME(&_hx_pos_df96f08def93db16_128_setResolver)
...
int Unserializer_obj::readDigits(){
            	HX_STACKFRAME(&_hx_pos_df96f08def93db16_147_readDigits)
...
Float Unserializer_obj::readFloat(){
            	HX_STACKFRAME(&_hx_pos_df96f08def93db16_172_readFloat)
...
void Unserializer_obj::unserializeObject( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_df96f08def93db16_186_unserializeObject)
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,unserializeObject,(void))
 ...
 ::Dynamic Unserializer_obj::unserializeEnum(hx::Class edecl,::String tag){
            	HX_STACKFRAME(&_hx_pos_df96f08def93db16_201_unserializeEnum)
...
HX_DEFINE_DYNAMIC_FUNC2(Unserializer_obj,unserializeEnum,return )
 ...
 ::Dynamic Unserializer_obj::unserialize(){
            	HX_GC_STACKFRAME(&_hx_pos_df96f08def93db16_233_unserialize)
HXLINE( 234)		{
...
::Array< int > Unserializer_obj::initCodes(){
            	HX_STACKFRAME(&_hx_pos_df96f08def93db16_70_initCodes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_df96f08def93db16_466_run)
