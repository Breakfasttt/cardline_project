...
HX_DEFINE_STACK_FRAME(_hx_pos_6e16e3a07c0cba3e_482_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",482,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_6e16e3a07c0cba3e_483_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",483,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_6e16e3a07c0cba3e_484_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",484,0x9355143c)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6e16e3a07c0cba3e_482_new)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6e16e3a07c0cba3e_483_resolveClass)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6e16e3a07c0cba3e_484_resolveEnum)
