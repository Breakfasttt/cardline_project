...
HX_DEFINE_STACK_FRAME(_hx_pos_e94b8e710f7d6967_476_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",476,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_e94b8e710f7d6967_477_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",477,0x9355143c)
HX_LOCAL_STACK_FRAME(_hx_pos_e94b8e710f7d6967_478_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",478,0x9355143c)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e94b8e710f7d6967_476_new)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_e94b8e710f7d6967_477_resolveClass)
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_e94b8e710f7d6967_478_resolveEnum)
