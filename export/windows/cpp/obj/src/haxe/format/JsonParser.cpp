...
HX_DEFINE_STACK_FRAME(_hx_pos_7ec3fd441934c397_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",51,0x51df9436)
HX_LOCAL_STACK_FRAME(_hx_pos_7ec3fd441934c397_57_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",57,0x51df9436)
HX_LOCAL_STACK_FRAME(_hx_pos_7ec3fd441934c397_138_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",138,0x51df9436)
HX_LOCAL_STACK_FRAME(_hx_pos_7ec3fd441934c397_249_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",249,0x51df9436)
HX_LOCAL_STACK_FRAME(_hx_pos_7ec3fd441934c397_255_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","C:\\dev\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",255,0x51df9436)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_7ec3fd441934c397_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_7ec3fd441934c397_57_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_7ec3fd441934c397_138_parseString)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_7ec3fd441934c397_249_invalidChar)
HXLINE( 250)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_7ec3fd441934c397_255_invalidNumber)
