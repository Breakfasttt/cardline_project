...
HXLINE(  16)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,(int)800,(int)600,hx::ClassOf< ::state::MenuState >(),((Float)1.0),(int)60,(int)60,true,false));
HXLINE(  17)		 ::flixel::_hx_system::frontEnds::PluginFrontEnd _hx_tmp = ::flixel::FlxG_obj::plugins;
HXDLIN(  17)		_hx_tmp->add_flixel_input_mouse_FlxMouseEventManager( ::flixel::input::mouse::FlxMouseEventManager_obj::__alloc( HX_CTX ));
            	}
