...
HX_DEFINE_STACK_FRAME(_hx_pos_63829a44c483cf07_31_new,"cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",31,0x12047aba)
HX_LOCAL_STACK_FRAME(_hx_pos_63829a44c483cf07_38_sendMessage,"cpp.vm.Thread","sendMessage",0x48dced27,"cpp.vm.Thread.sendMessage","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",38,0x12047aba)
HX_LOCAL_STACK_FRAME(_hx_pos_63829a44c483cf07_66___compare,"cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",66,0x12047aba)
HX_LOCAL_STACK_FRAME(_hx_pos_63829a44c483cf07_46_current,"cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",46,0x12047aba)
HX_LOCAL_STACK_FRAME(_hx_pos_63829a44c483cf07_53_create,"cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",53,0x12047aba)
HX_LOCAL_STACK_FRAME(_hx_pos_63829a44c483cf07_62_readMessage,"cpp.vm.Thread","readMessage",0x11bc2cd9,"cpp.vm.Thread.readMessage","C:\\dev\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",62,0x12047aba)
namespace cpp{
namespace vm{
...
void Thread_obj::sendMessage( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_63829a44c483cf07_38_sendMessage)
...
int Thread_obj::__compare( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_63829a44c483cf07_66___compare)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_63829a44c483cf07_46_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_obj,current,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_GC_STACKFRAME(&_hx_pos_63829a44c483cf07_53_create)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,create,return )
 ...
 ::Dynamic Thread_obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_63829a44c483cf07_62_readMessage)
