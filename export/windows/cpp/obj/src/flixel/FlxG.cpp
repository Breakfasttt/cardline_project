...
HXLINE( 346)		 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
...
HXLINE(  95)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,(int)4,(int)2,(int)1);
            	}
{
...
HXLINE( 169)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
