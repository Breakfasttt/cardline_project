...
HX_LOCAL_STACK_FRAME(_hx_pos_4a20ba41f30cf210_22_add_flixel_input_mouse_FlxMouseEventManager,"flixel.system.frontEnds.PluginFrontEnd","add_flixel_input_mouse_FlxMouseEventManager",0x14733beb,"flixel.system.frontEnds.PluginFrontEnd.add_flixel_input_mouse_FlxMouseEventManager","flixel/system/frontEnds/PluginFrontEnd.hx",22,0xbff70e9e)
...
bool PluginFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::input::mouse::FlxMouseEventManager PluginFrontEnd_obj::add_flixel_input_mouse_FlxMouseEventManager( ::flixel::input::mouse::FlxMouseEventManager Plugin){
            	HX_STACKFRAME(&_hx_pos_4a20ba41f30cf210_22_add_flixel_input_mouse_FlxMouseEventManager)
HXLINE(  24)		{
...
HXLINE( 118)			 ::flixel::FlxBasic plugin = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 133)			 ::flixel::FlxBasic plugin = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
