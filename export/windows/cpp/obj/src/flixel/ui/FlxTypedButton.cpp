...
HXLINE( 306)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
...
HXLINE( 603)		 ::flixel::input::FlxInput _this = this->input;
...
HXLINE( 608)		 ::flixel::input::FlxInput _this = this->input;
