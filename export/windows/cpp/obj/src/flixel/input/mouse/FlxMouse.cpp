...
HXLINE( 497)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
...
HXLINE( 502)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
...
HXLINE( 506)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
