...
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_331_destroy,"flixel.input.mouse.FlxMouseEventManager","destroy",0x1c6eaf31,"flixel.input.mouse.FlxMouseEventManager.destroy","flixel/input/mouse/FlxMouseEventManager.hx",331,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_338_update,"flixel.input.mouse.FlxMouseEventManager","update",0x84b077b2,"flixel.input.mouse.FlxMouseEventManager.update","flixel/input/mouse/FlxMouseEventManager.hx",338,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_430_clearRegistry,"flixel.input.mouse.FlxMouseEventManager","clearRegistry",0xaf4f39e1,"flixel.input.mouse.FlxMouseEventManager.clearRegistry","flixel/input/mouse/FlxMouseEventManager.hx",430,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_442_checkOverlap,"flixel.input.mouse.FlxMouseEventManager","checkOverlap",0x58381208,"flixel.input.mouse.FlxMouseEventManager.checkOverlap","flixel/input/mouse/FlxMouseEventManager.hx",442,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_472_checkOverlapWithPoint,"flixel.input.mouse.FlxMouseEventManager","checkOverlapWithPoint",0x0bd96542,"flixel.input.mouse.FlxMouseEventManager.checkOverlapWithPoint","flixel/input/mouse/FlxMouseEventManager.hx",472,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_483_checkPixelPerfectOverlap,"flixel.input.mouse.FlxMouseEventManager","checkPixelPerfectOverlap",0xb8bf1721,"flixel.input.mouse.FlxMouseEventManager.checkPixelPerfectOverlap","flixel/input/mouse/FlxMouseEventManager.hx",483,0x750c3856)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_109_removeAll,"flixel.input.mouse.FlxMouseEventManager","removeAll",0xef9bd534,"flixel.input.mouse.FlxMouseEventManager.removeAll","flixel/input/mouse/FlxMouseEventManager.hx",109,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_129_reorder,"flixel.input.mouse.FlxMouseEventManager","reorder",0x13a3c632,"flixel.input.mouse.FlxMouseEventManager.reorder","flixel/input/mouse/FlxMouseEventManager.hx",129,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_144_setMouseDownCallback,"flixel.input.mouse.FlxMouseEventManager","setMouseDownCallback",0xe8b31b73,"flixel.input.mouse.FlxMouseEventManager.setMouseDownCallback","flixel/input/mouse/FlxMouseEventManager.hx",144,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_160_setMouseUpCallback,"flixel.input.mouse.FlxMouseEventManager","setMouseUpCallback",0x3b6a476c,"flixel.input.mouse.FlxMouseEventManager.setMouseUpCallback","flixel/input/mouse/FlxMouseEventManager.hx",160,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_176_setMouseOverCallback,"flixel.input.mouse.FlxMouseEventManager","setMouseOverCallback",0x088af665,"flixel.input.mouse.FlxMouseEventManager.setMouseOverCallback","flixel/input/mouse/FlxMouseEventManager.hx",176,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_192_setMouseOutCallback,"flixel.input.mouse.FlxMouseEventManager","setMouseOutCallback",0x235b22c7,"flixel.input.mouse.FlxMouseEventManager.setMouseOutCallback","flixel/input/mouse/FlxMouseEventManager.hx",192,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_207_setObjectMouseEnabled,"flixel.input.mouse.FlxMouseEventManager","setObjectMouseEnabled",0xe24566f4,"flixel.input.mouse.FlxMouseEventManager.setObjectMouseEnabled","flixel/input/mouse/FlxMouseEventManager.hx",207,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_220_isObjectMouseEnabled,"flixel.input.mouse.FlxMouseEventManager","isObjectMouseEnabled",0x6e5fac2e,"flixel.input.mouse.FlxMouseEventManager.isObjectMouseEnabled","flixel/input/mouse/FlxMouseEventManager.hx",220,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_239_setObjectMouseChildren,"flixel.input.mouse.FlxMouseEventManager","setObjectMouseChildren",0x9e2bdb6c,"flixel.input.mouse.FlxMouseEventManager.setObjectMouseChildren","flixel/input/mouse/FlxMouseEventManager.hx",239,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_252_isObjectMouseChildren,"flixel.input.mouse.FlxMouseEventManager","isObjectMouseChildren",0xa90e28f2,"flixel.input.mouse.FlxMouseEventManager.isObjectMouseChildren","flixel/input/mouse/FlxMouseEventManager.hx",252,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_269_setObjectMouseButtons,"flixel.input.mouse.FlxMouseEventManager","setObjectMouseButtons",0x2e89b4b4,"flixel.input.mouse.FlxMouseEventManager.setObjectMouseButtons","flixel/input/mouse/FlxMouseEventManager.hx",269,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_281_traverseFlxGroup,"flixel.input.mouse.FlxMouseEventManager","traverseFlxGroup",0xb5503c28,"flixel.input.mouse.FlxMouseEventManager.traverseFlxGroup","flixel/input/mouse/FlxMouseEventManager.hx",281,0x750c3856)
HX_LOCAL_STACK_FRAME(_hx_pos_7737cad62ef16250_301_getRegister,"flixel.input.mouse.FlxMouseEventManager","getRegister",0xc4eed2d0,"flixel.input.mouse.FlxMouseEventManager.getRegister","flixel/input/mouse/FlxMouseEventManager.hx",301,0x750c3856)
...
HXLINE( 341)		::Array< ::Dynamic> currentOverObjects = ::Array_obj< ::Dynamic>::__new();
HXLINE( 343)		{
HXLINE( 343)			int _g = (int)0;
HXDLIN( 343)			::Array< ::Dynamic> _g1 = ::flixel::input::mouse::FlxMouseEventManager_obj::_registeredObjects;
HXDLIN( 343)			while((_g < _g1->length)){
HXLINE( 343)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 369)		{
HXLINE( 369)			int _g2 = (int)0;
HXDLIN( 369)			while((_g2 < currentOverObjects->length)){
HXLINE( 369)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData current = currentOverObjects->__get(_g2).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 381)		{
HXLINE( 381)			int _g3 = (int)0;
HXDLIN( 381)			::Array< ::Dynamic> _g11 = ::flixel::input::mouse::FlxMouseEventManager_obj::_mouseOverObjects;
HXDLIN( 381)			while((_g3 < _g11->length)){
HXLINE( 381)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData over = _g11->__get(_g3).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 396)		{
HXLINE( 396)			int _g4 = (int)0;
HXDLIN( 396)			while((_g4 < currentOverObjects->length)){
HXLINE( 396)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData current1 = currentOverObjects->__get(_g4).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 400)					int _g12 = (int)0;
HXDLIN( 400)					::Array< int > _g21 = current1->mouseButtons;
HXDLIN( 400)					while((_g12 < _g21->length)){
HXLINE( 400)						int buttonID = _g21->__get(_g12);
...
HXLINE( 411)		{
HXLINE( 411)			int _g5 = (int)0;
HXDLIN( 411)			while((_g5 < currentOverObjects->length)){
HXLINE( 411)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData current2 = currentOverObjects->__get(_g5).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 415)					int _g13 = (int)0;
HXDLIN( 415)					::Array< int > _g22 = current2->mouseButtons;
HXDLIN( 415)					while((_g13 < _g22->length)){
HXLINE( 415)						int buttonID1 = _g22->__get(_g13);
...
HXDLIN( 433)			::Array< ::Dynamic> _g1 = ::flixel::input::mouse::FlxMouseEventManager_obj::_registeredObjects;
HXDLIN( 433)			while((_g < _g1->length)){
HXLINE( 433)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXDLIN( 443)			::Array< ::Dynamic> _g1 = Register->object->get_cameras();
HXDLIN( 443)			while((_g < _g1->length)){
HXLINE( 443)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 448)				 ::flixel::math::FlxPoint Point = ::flixel::input::mouse::FlxMouseEventManager_obj::_point;
...
HXLINE( 448)					 ::flixel::FlxSprite Sprite = Register->sprite;
HXDLIN( 448)					if ((Sprite->angle != (int)0)) {
HXLINE( 448)						Float X = (Sprite->x + Sprite->origin->x);
HXDLIN( 448)						Float Y = (Sprite->y + Sprite->origin->y);
HXDLIN( 448)						 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 448)						point->_inPool = false;
HXDLIN( 448)						 ::flixel::math::FlxPoint point1 = point;
HXDLIN( 448)						point1->_weak = true;
HXDLIN( 448)						 ::flixel::math::FlxPoint pivot = point1;
HXDLIN( 448)						Point->rotate(pivot,-(Sprite->angle));
            					}
...
HXLINE( 474)			 ::flixel::FlxSprite Sprite = Register->sprite;
HXDLIN( 474)			if ((Sprite->angle != (int)0)) {
HXLINE( 474)				Float X = (Sprite->x + Sprite->origin->x);
HXDLIN( 474)				Float Y = (Sprite->y + Sprite->origin->y);
HXDLIN( 474)				 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 474)				point->_inPool = false;
HXDLIN( 474)				 ::flixel::math::FlxPoint point1 = point;
HXDLIN( 474)				point1->_weak = true;
HXDLIN( 474)				 ::flixel::math::FlxPoint pivot = point1;
HXDLIN( 474)				Point->rotate(pivot,-(Sprite->angle));
            			}
...
HXDLIN( 486)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 486)			point->_inPool = false;
HXDLIN( 486)			 ::flixel::math::FlxPoint point1 = point;
HXDLIN( 486)			point1->_weak = true;
HXDLIN( 486)			 ::flixel::math::FlxPoint pivot = point1;
HXLINE( 487)			Point->rotate(pivot,-(Sprite->angle));
            		}
...
HXDLIN( 112)			::Array< ::Dynamic> _g1 = ::flixel::input::mouse::FlxMouseEventManager_obj::_registeredObjects;
HXDLIN( 112)			while((_g < _g1->length)){
HXLINE( 112)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE( 130)		::Array< ::Dynamic> orderedObjects = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 145)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 161)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 177)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 193)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 208)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 221)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 240)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 253)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(Object,null());
...
HXLINE( 270)		 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(object,null());
...
HXDLIN( 281)		::cpp::VirtualArray _g1 = Group->members;
HXDLIN( 281)		while((_g < _g1->get_length())){
HXLINE( 281)			 ::Dynamic basic = _g1->__get(_g);
HXDLIN( 281)			_g = (_g + (int)1);
HXLINE( 283)			 ::flixel::group::FlxTypedGroup group = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXLINE( 290)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = ::flixel::input::mouse::FlxMouseEventManager_obj::getRegister(( ( ::flixel::FlxObject)(basic) ),null());
...
HXLINE( 307)		{
HXLINE( 307)			int _g = (int)0;
HXDLIN( 307)			while((_g < Register->length)){
HXLINE( 307)				 ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData reg = Register->__get(_g).StaticCast<  ::flixel::input::mouse::_FlxMouseEventManager::ObjectMouseData >();
...
HXLINE(  40)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
