...
HX_DEFINE_STACK_FRAME(_hx_pos_da4931f1149b180b_509_new,"flixel.input.mouse._FlxMouseEventManager.ObjectMouseData","new",0xb9a85afa,"flixel.input.mouse._FlxMouseEventManager.ObjectMouseData.new","flixel/input/mouse/FlxMouseEventManager.hx",509,0x750c3856)
...
void ObjectMouseData_obj::__construct( ::Dynamic object, ::Dynamic onMouseDown, ::Dynamic onMouseUp, ::Dynamic onMouseOver, ::Dynamic onMouseOut,bool mouseChildren,bool mouseEnabled,bool pixelPerfect,::Array< int > mouseButtons){
            	HX_STACKFRAME(&_hx_pos_da4931f1149b180b_509_new)
HXLINE( 510)		this->object = ( ( ::flixel::FlxObject)(object) );
HXLINE( 511)		this->onMouseDown = onMouseDown;
HXLINE( 512)		this->onMouseUp = onMouseUp;
HXLINE( 513)		this->onMouseOver = onMouseOver;
HXLINE( 514)		this->onMouseOut = onMouseOut;
HXLINE( 515)		this->mouseChildren = mouseChildren;
HXLINE( 516)		this->mouseEnabled = mouseEnabled;
HXLINE( 517)		this->pixelPerfect = pixelPerfect;
HXLINE( 518)		::Array< int > _hx_tmp;
HXDLIN( 518)		if (hx::IsNull( mouseButtons )) {
HXLINE( 518)			_hx_tmp = ::Array_obj< int >::fromData( _hx_array_data_50751608_1,1);
            		}
            		else {
HXLINE( 518)			_hx_tmp = mouseButtons;
            		}
HXDLIN( 518)		this->mouseButtons = _hx_tmp;
            	}
