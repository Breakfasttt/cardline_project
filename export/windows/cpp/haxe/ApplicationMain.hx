...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Breakyt", "cardlineproject", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "cardline_project";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "cardline_project", null, { width: 800, height: 600 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "84",
			company: "Breakyt",
			file: "cardlineproject",
			fps: 60,
			name: "cardline_project",
